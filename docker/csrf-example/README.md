...
На изображении ниже обратите внимание что:

- код ответа 200
- куки отправляются такие же, как и на изображении, выше
- Заголовок Origin означает что запрос был сделан с localhost:9090

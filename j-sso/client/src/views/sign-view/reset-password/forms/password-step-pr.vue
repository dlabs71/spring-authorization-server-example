...
<script setup>
    ...
    // computed
    let isShowed = computed(() => store.getters.getResetPasswordStep === STEPS.PASSWORD);
    let storedRegistrationData = computed(() => store.getters.getResetPasswordData);

    ...
    <form-wrapper>
        ...
        <div class="slider">
            <v-scroll-x-reverse-transition>
                <init-form-pr ref="initStepForm" v-show="showInit" @next="enterData"/>
            </v-scroll-x-reverse-transition>
            <v-scroll-x-reverse-transition>
                <confirm-form-pr ref="confirmStepForm" v-show="showConfirm" @next="enterData"
...
let initResetPassword = (email) => {
    return ForgetPasswordService.initReset(email);
};
...
let enterData = (dataForm) => {
    ...
    if (showConfirm.value) {
        ForgetPasswordService.confirmReset(dataForm.confirmCode).then(() => {
            nextStep();
        }).catch(() => {
    ...
    if (showPassword.value) {
        ...
        ForgetPasswordService.setNewPassword(dataForm.password, resetSessionId).then(() => {
